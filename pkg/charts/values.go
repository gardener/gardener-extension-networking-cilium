...
func RenderCiliumChart(renderer chartrenderer.Interface, network *extensionsv1alpha1.Network, config *ciliumv1alpha1.NetworkConfig) ([]byte, error) {
	values, err := ComputeCiliumChartValues(network, config)
	if err != nil {
		return nil, err
	}
