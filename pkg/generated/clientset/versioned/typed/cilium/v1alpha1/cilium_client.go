...
import (
	...
	"k8s.io/cilium/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CiliumV1alpha1Interface interface {
	RESTClient() rest.Interface
	CiliumNetworksGetter
}

// CiliumV1alpha1Client is used to interact with features provided by the cilium.k8s.io group.
type CiliumV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CiliumV1alpha1Client) CiliumNetworks(namespace string) CiliumNetworkInterface {
	return newCiliumNetworks(c, namespace)
}
