...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WireguardEncryption) DeepCopyInto(out *WireguardEncryption) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WireguardEncryption.
func (in *WireguardEncryption) DeepCopy() *WireguardEncryption {
	if in == nil {
		return nil
	}
	out := new(WireguardEncryption)
	in.DeepCopyInto(out)
	return out
}
