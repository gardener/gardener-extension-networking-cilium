...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*IPSec)(nil), (*cilium.IPSec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_IPSec_To_cilium_IPSec(a.(*IPSec), b.(*cilium.IPSec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*cilium.IPSec)(nil), (*IPSec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_cilium_IPSec_To_v1alpha1_IPSec(a.(*cilium.IPSec), b.(*IPSec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Encryption_To_cilium_Encryption(in *Encryption, out *cilium.Encryption, s conversion.Scope) error {
	...
	out.IPSec = (*cilium.IPSec)(unsafe.Pointer(in.IPSec))
	return nil
}
...
func autoConvert_cilium_Encryption_To_v1alpha1_Encryption(in *cilium.Encryption, out *Encryption, s conversion.Scope) error {
	...
	out.SecretName = in.SecretName
	out.NodeEncryption = in.NodeEncryption
	out.IPSec = (*IPSec)(unsafe.Pointer(in.IPSec))
	return nil
}
...
func autoConvert_v1alpha1_IPSec_To_cilium_IPSec(in *IPSec, out *cilium.IPSec, s conversion.Scope) error {
	out.KeyID = in.KeyID
	out.EncryptionAlgorithms = in.EncryptionAlgorithms
	out.PreSharedKey = in.PreSharedKey
	out.KeySize = in.KeySize
	return nil
}

// Convert_v1alpha1_IPSec_To_cilium_IPSec is an autogenerated conversion function.
func Convert_v1alpha1_IPSec_To_cilium_IPSec(in *IPSec, out *cilium.IPSec, s conversion.Scope) error {
	return autoConvert_v1alpha1_IPSec_To_cilium_IPSec(in, out, s)
}

func autoConvert_cilium_IPSec_To_v1alpha1_IPSec(in *cilium.IPSec, out *IPSec, s conversion.Scope) error {
	out.KeyID = in.KeyID
	out.EncryptionAlgorithms = in.EncryptionAlgorithms
	out.PreSharedKey = in.PreSharedKey
	out.KeySize = in.KeySize
...
// Convert_cilium_IPSec_To_v1alpha1_IPSec is an autogenerated conversion function.
func Convert_cilium_IPSec_To_v1alpha1_IPSec(in *cilium.IPSec, out *IPSec, s conversion.Scope) error {
	return autoConvert_cilium_IPSec_To_v1alpha1_IPSec(in, out, s)
}
