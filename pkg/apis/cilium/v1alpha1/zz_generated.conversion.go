...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*L2Announcements)(nil), (*cilium.L2Announcements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_L2Announcements_To_cilium_L2Announcements(a.(*L2Announcements), b.(*cilium.L2Announcements), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*cilium.L2Announcements)(nil), (*L2Announcements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_cilium_L2Announcements_To_v1alpha1_L2Announcements(a.(*cilium.L2Announcements), b.(*L2Announcements), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*LoadBalancer)(nil), (*cilium.LoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_LoadBalancer_To_cilium_LoadBalancer(a.(*LoadBalancer), b.(*cilium.LoadBalancer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*cilium.LoadBalancer)(nil), (*LoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_cilium_LoadBalancer_To_v1alpha1_LoadBalancer(a.(*cilium.LoadBalancer), b.(*LoadBalancer), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_L2Announcements_To_cilium_L2Announcements is an autogenerated conversion function.
func Convert_v1alpha1_L2Announcements_To_cilium_L2Announcements(in *L2Announcements, out *cilium.L2Announcements, s conversion.Scope) error {
	return autoConvert_v1alpha1_L2Announcements_To_cilium_L2Announcements(in, out, s)
}
...
// Convert_cilium_L2Announcements_To_v1alpha1_L2Announcements is an autogenerated conversion function.
func Convert_cilium_L2Announcements_To_v1alpha1_L2Announcements(in *cilium.L2Announcements, out *L2Announcements, s conversion.Scope) error {
	return autoConvert_cilium_L2Announcements_To_v1alpha1_L2Announcements(in, out, s)
}

func autoConvert_v1alpha1_LoadBalancer_To_cilium_LoadBalancer(in *LoadBalancer, out *cilium.LoadBalancer, s conversion.Scope) error {
	out.Mode = (*cilium.LoadBalancingMode)(unsafe.Pointer(in.Mode))
	out.ModeAnnotation = in.ModeAnnotation
	out.DSRDispatch = (*cilium.DSRDispatch)(unsafe.Pointer(in.DSRDispatch))
	out.Acceleration = (*cilium.Acceleration)(unsafe.Pointer(in.Acceleration))
	out.Algorithm = (*cilium.LoadBalancerAlgorithm)(unsafe.Pointer(in.Algorithm))
	out.AlgorithmAnnotation = in.AlgorithmAnnotation
	return nil
}

// Convert_v1alpha1_LoadBalancer_To_cilium_LoadBalancer is an autogenerated conversion function.
func Convert_v1alpha1_LoadBalancer_To_cilium_LoadBalancer(in *LoadBalancer, out *cilium.LoadBalancer, s conversion.Scope) error {
	return autoConvert_v1alpha1_LoadBalancer_To_cilium_LoadBalancer(in, out, s)
}

func autoConvert_cilium_LoadBalancer_To_v1alpha1_LoadBalancer(in *cilium.LoadBalancer, out *LoadBalancer, s conversion.Scope) error {
	out.Mode = (*LoadBalancingMode)(unsafe.Pointer(in.Mode))
	out.ModeAnnotation = in.ModeAnnotation
	out.DSRDispatch = (*DSRDispatch)(unsafe.Pointer(in.DSRDispatch))
	out.Acceleration = (*Acceleration)(unsafe.Pointer(in.Acceleration))
	out.Algorithm = (*LoadBalancerAlgorithm)(unsafe.Pointer(in.Algorithm))
	out.AlgorithmAnnotation = in.AlgorithmAnnotation
	return nil
}

// Convert_cilium_LoadBalancer_To_v1alpha1_LoadBalancer is an autogenerated conversion function.
func Convert_cilium_LoadBalancer_To_v1alpha1_LoadBalancer(in *cilium.LoadBalancer, out *LoadBalancer, s conversion.Scope) error {
	return autoConvert_cilium_LoadBalancer_To_v1alpha1_LoadBalancer(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_cilium_NetworkConfig(in *NetworkConfig, out *cilium.NetworkConfig, s conversion.Scope) error {
	...
	out.LoadBalancer = (*cilium.LoadBalancer)(unsafe.Pointer(in.LoadBalancer))
	out.L2Announcements = (*cilium.L2Announcements)(unsafe.Pointer(in.L2Announcements))
...
func autoConvert_cilium_NetworkConfig_To_v1alpha1_NetworkConfig(in *cilium.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.L2Announcements = (*L2Announcements)(unsafe.Pointer(in.L2Announcements))
	out.IPv4NativeRoutingCIDREnabled = (*bool)(unsafe.Pointer(in.IPv4NativeRoutingCIDREnabled))
	out.IPv6NativeRoutingCIDREnabled = (*bool)(unsafe.Pointer(in.IPv6NativeRoutingCIDREnabled))
