...
//go:generate crd-ref-docs --source-path=. --config=../../../../hack/api-reference/cilium.yaml --renderer=markdown --templates-dir=$GARDENER_HACK_DIR/api-reference/template --log-level=ERROR --output-path=../../../../hack/api-reference/cilium.md
