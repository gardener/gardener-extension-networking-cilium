...
FROM gcr.io/distroless/static-debian12:nonroot AS gardener-extension-networking-cilium
WORKDIR /
...
FROM gcr.io/distroless/static-debian12:nonroot AS gardener-extension-admission-cilium
WORKDIR /
